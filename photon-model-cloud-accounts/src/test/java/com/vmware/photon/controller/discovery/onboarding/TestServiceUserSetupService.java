...
public class TestServiceUserSetupService extends BasicTestCase {
    ...
    @Test
    public void testServiceUserSetup() throws Throwable {
        ...
        this.host.addPrivilegedService(ServiceUserSetupService.class);
        this.host.startService(new ServiceUserSetupService());
        this.host.waitForServiceAvailable(ServiceUserSetupService.SELF_LINK);
        ...
        UserState userState = Utils.fromJson(res.documents.values().iterator().next(),
                UserState.class);
        assertEquals(userState.email, SERVICE_USER_EMAIL);
        ...
        assertEquals(authCredentials.userEmail, SERVICE_USER_EMAIL);
        ...
        assertEquals(roleState.userGroupLink,
                UriUtils.buildUriPath(UserGroupService.FACTORY_LINK, SERVICE_USER_GROUP_NAME));
        assertEquals(roleState.resourceGroupLink,
                UriUtils.buildUriPath(ResourceGroupService.FACTORY_LINK,
                        SERVICE_USER_RESOURCE_GROUP_NAME));
        res = SymphonyCommonTestUtils.queryDocuments(this.host, this.host.getUri(),
        ...
        assertEquals(SERVICE_USER_EMAIL,
