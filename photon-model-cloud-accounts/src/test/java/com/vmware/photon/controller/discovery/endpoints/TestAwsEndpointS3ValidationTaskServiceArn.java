...
public class TestAwsEndpointS3ValidationTaskServiceArn extends BasicTestCase {
    ...
    public void setUp() throws Throwable {
        ...
        assumeTrue(SymphonyCommonTestUtils.isNull(this.awsMasterAccountAccessKey,
                this.awsMasterAccountSecretKey, this.externalId, this.arn, this.s3bucketName));
    ...
    @Test
    public void testS3BucketPermissionsValidationArn() throws Throwable {
        S3ValidationTaskState validateTask = new S3ValidationTaskState();
        validateTask.credentials = createAwsCredentialsArn(this.arn, this.externalId);
