...
import static com.vmware.photon.controller.model.UriPaths.RESOURCE_PROPERTIES_SERVICE;
 ...
 */
public class ResourcePropertiesQueryService extends StatelessService {
    public static String SELF_LINK = RESOURCE_PROPERTIES_SERVICE;
    ...
    static {
        ...
        filterList.addAll(ResourcesQueryTaskServiceV3.SUPPORTED_FILTER_MAP.keySet());
        filterList.addAll(ResourcesQueryTaskServiceV3.SUPPORTED_ENDPOINT_FIELDS_FILTER_MAP.keySet());
        filterList.addAll(ResourcesQueryTaskServiceV3.SUPPORTED_TAGS_FIELDS_FILTER_MAP.keySet());
        filterList.addAll(ResourcesQueryTaskServiceV3.SUPPORTED_TYPE_FILTER_MAP.keySet());
    }
    ...
    private static void parsePropertiesInClass(Class<?> classType,
        ...
        for (Field field : classType.getFields()) {
            ...
            if (!Modifier.isStatic(modifiers)
                ...
                // include ServiceDocument type classes. Can we changed to be more inclusive of
