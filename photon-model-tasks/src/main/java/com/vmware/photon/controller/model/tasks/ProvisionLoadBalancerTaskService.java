 ...
 *
 * TODO pmitrov: create a common utility for task services which only goal is to call an adapter
 * and wait for the response.
 */
public class ProvisionLoadBalancerTaskService extends TaskService<ProvisionLoadBalancerTaskService.ProvisionLoadBalancerTaskState> {
