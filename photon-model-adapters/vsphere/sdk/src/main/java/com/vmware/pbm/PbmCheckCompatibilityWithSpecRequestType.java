...
/**
 * <p>Java class for PbmCheckCompatibilityWithSpecRequestType complex type.
 * 
 ...
 *         &lt;element name="profileSpec" type="{urn:pbm}PbmCapabilityProfileCreateSpec"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "PbmCheckCompatibilityWithSpecRequestType", propOrder = {
    "_this",
    "hubsToSearch",
    "profileSpec"
})
public class PbmCheckCompatibilityWithSpecRequestType {

    @XmlElement(required = true)
    protected ManagedObjectReference _this;
    protected List<PbmPlacementHub> hubsToSearch;
    @XmlElement(required = true)
    protected PbmCapabilityProfileCreateSpec profileSpec;
     ...
     *     
     */
    public PbmCapabilityProfileCreateSpec getProfileSpec() {
        return profileSpec;
    }
     ...
     *     
     */
    public void setProfileSpec(PbmCapabilityProfileCreateSpec value) {
        this.profileSpec = value;
    }
